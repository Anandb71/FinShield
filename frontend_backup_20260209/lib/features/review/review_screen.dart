              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    ...
                    Text('${_queue.length} items pending', style: LiquidTheme.monoData(size: 9, color: LiquidTheme.textMuted), overflow: TextOverflow.ellipsis),
                  ],
                ),
              ),
              if (!_isOnline)
      ...
      child: Center(
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 32),
            const SizedBox(height: 32),
            Text('Use the tabs below to navigate', style: LiquidTheme.monoData(size: 12, color: LiquidTheme.textMuted)),
